...
const downloadTranslations = {
    en: {
      ...
      "dualvpn-desc": "Advanced VPN management tool with multi-connection support for MacOS",
    ...
    zh: {
      ...
      "dualvpn-desc": "支持MacOS的多连接高级VPN管理工具",
...
// Merge with existing translations immediately
...
// Re-translate the page if language is already set
document.addEventListener('DOMContentLoaded', function() {
  // Re-translate the page with current language
  if (typeof currentLang !== 'undefined' && typeof translatePage === 'function') {
